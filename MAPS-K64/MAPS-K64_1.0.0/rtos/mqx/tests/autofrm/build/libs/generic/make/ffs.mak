#===================================================================================================
#
#    @brief   Main makefile for FFS library
#
#===================================================================================================
...
-include $(DEV_DIR)/lib/$(CNFG)/$(PLATFORM).$(TOOLCHAIN)/$(CONFIGURATION_LC)/ffs/ffs_$(PLATFORM).mak
...
POST_BUILD_CMD += $(CP) $(DEV_DIR)/lib/$(CNFG)/$(PLATFORM).$(TOOLCHAIN)/$(CONFIGURATION_LC)/ffs/out/ffs.$(EXE_EXT) \
$(DEV_DIR)/lib/$(CNFG)/$(PLATFORM).$(TOOLCHAIN)/$(CONFIGURATION_LC)/ffs/ffs.$(EXE_EXT) &&

# Run post-build LIB bat file
POST_BUILD_CMD += $(call winpath,$(DEV_DIR))/ffs/build/bat/ffs_$(PLATFORM).bat \
$(call winpath,$(DEV_DIR)) \
$(call winpath,$(DEV_DIR))/lib/$(CNFG)/$(PLATFORM).$(TOOLCHAIN)/$(CONFIGURATION_LC)/ffs \
$(TOOLCHAIN) &&
