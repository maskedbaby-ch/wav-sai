#===================================================================================================
#
#    @brief   Main makefile for mqx_stdlib library
#
#===================================================================================================
...
-include $(DEV_DIR)/lib/$(CNFG)/$(PLATFORM).$(TOOLCHAIN)/$(CONFIGURATION_LC)/mqx_stdlib/mqx_stdlib_$(PLATFORM).mak
...
POST_BUILD_CMD += $(CP) $(DEV_DIR)/lib/$(CNFG)/$(PLATFORM).$(TOOLCHAIN)/$(CONFIGURATION_LC)/mqx_stdlib/out/mqx_stdlib.$(EXE_EXT) \
$(DEV_DIR)/lib/$(CNFG)/$(PLATFORM).$(TOOLCHAIN)/$(CONFIGURATION_LC)/mqx_stdlib/mqx_stdlib.$(EXE_EXT) &&

# Run post-build LIB bat file
POST_BUILD_CMD += $(call winpath,$(DEV_DIR))/mqx_stdlib/build/bat/mqx_stdlib_$(PLATFORM).bat \
$(call winpath,$(DEV_DIR)) \
$(call winpath,$(DEV_DIR))/lib/$(CNFG)/$(PLATFORM).$(TOOLCHAIN)/$(CONFIGURATION_LC)/mqx_stdlib \
$(TOOLCHAIN) &&
