#===================================================================================================
#
#    @brief   Main makefile for USB Host library
#
#===================================================================================================
...
-include $(DEV_DIR)/lib/$(CNFG)/$(PLATFORM).$(TOOLCHAIN)/$(CONFIGURATION_LC)/usb/usbh_$(PLATFORM).mak
...
POST_BUILD_CMD += $(CP) $(DEV_DIR)/lib/$(CNFG)/$(PLATFORM).$(TOOLCHAIN)/$(CONFIGURATION_LC)/usbh/out/usbh.$(EXE_EXT) \
$(DEV_DIR)/lib/$(CNFG)/$(PLATFORM).$(TOOLCHAIN)/$(CONFIGURATION_LC)/usb/usbh.$(EXE_EXT) && 

# Run post-build LIB bat file
POST_BUILD_CMD += $(call winpath,$(DEV_DIR))/usb/host/build/bat/usbh_$(PLATFORM).bat \
