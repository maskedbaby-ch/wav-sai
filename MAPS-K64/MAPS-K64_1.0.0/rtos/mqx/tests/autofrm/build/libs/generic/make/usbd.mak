#===================================================================================================
#
#    @brief   Main makefile for USB Device library
#
#===================================================================================================
...
-include $(DEV_DIR)/lib/$(CNFG)/$(PLATFORM).$(TOOLCHAIN)/$(CONFIGURATION_LC)/usb/usbd_$(PLATFORM).mak
...
POST_BUILD_CMD += $(CP) $(DEV_DIR)/lib/$(CNFG)/$(PLATFORM).$(TOOLCHAIN)/$(CONFIGURATION_LC)/usbd/out/usbd.$(EXE_EXT) \
$(DEV_DIR)/lib/$(CNFG)/$(PLATFORM).$(TOOLCHAIN)/$(CONFIGURATION_LC)/usb/usbd.$(EXE_EXT) && 

# Run post-build LIB bat file
POST_BUILD_CMD += $(call winpath,$(DEV_DIR))/usb/device/build/bat/usbd_$(PLATFORM).bat \
$(call winpath,$(DEV_DIR)) \
$(call winpath,$(DEV_DIR))/lib/$(CNFG)/$(PLATFORM).$(TOOLCHAIN)/$(CONFIGURATION_LC)/usb \
$(TOOLCHAIN) &&
