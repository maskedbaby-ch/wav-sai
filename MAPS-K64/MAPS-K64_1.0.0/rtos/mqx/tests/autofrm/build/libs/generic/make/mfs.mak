#===================================================================================================
#
#    @brief   Main makefile for MFS library
#
#===================================================================================================
...
-include $(DEV_DIR)/lib/$(CNFG)/$(PLATFORM).$(TOOLCHAIN)/$(CONFIGURATION_LC)/mfs/mfs_$(PLATFORM).mak
...
POST_BUILD_CMD += $(CP) $(DEV_DIR)/lib/$(CNFG)/$(PLATFORM).$(TOOLCHAIN)/$(CONFIGURATION_LC)/mfs/out/mfs.$(EXE_EXT) \
$(DEV_DIR)/lib/$(CNFG)/$(PLATFORM).$(TOOLCHAIN)/$(CONFIGURATION_LC)/mfs/mfs.$(EXE_EXT) && 

# Run post-build LIB bat file
POST_BUILD_CMD += $(call winpath,$(DEV_DIR))/mfs/build/bat/mfs_$(PLATFORM).bat \
$(call winpath,$(DEV_DIR)) \
$(call winpath,$(DEV_DIR))/lib/$(CNFG)/$(PLATFORM).$(TOOLCHAIN)/$(CONFIGURATION_LC)/mfs \
$(TOOLCHAIN) &&
