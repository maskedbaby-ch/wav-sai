...
<!-------------------------------  COMPILER cw88 ---------------------->
<!----------------------------------------------------------------------------->
 <td><h4 class="fsbolero" align="center" >cw88</h4>
    ...
    <tbody>
      ...
      <tr><td colspan="2">
        <table class="index" width="100%" cellpadding="0" cellspacing="1">
          ...
          if (logDir_cw88.isDirectory() == false) {
        %><tr><td>Context parameter logDir needs to be set to a directory. Currently set to &quot;<%=logDirPath%>
          &quot;</td></tr><%
        }
        else {
          String[] projectDirs = logDir_cw88.list(new java.io.FilenameFilter() {
            public boolean accept(File dir, String filename) {
               boolean fileOK = true;
				fileOK &= filename.endsWith("cw88");
				fileOK &= filename.startsWith("ar_ccov_int_");
               return fileOK;
            }
          });
          ...
          <tbody>
            <%
              ...
              for (int i = 0; i < info.length; i++) {
				 ...
				 String moduleName=info[i].project.replaceAll("ar_ccov_int_","");
