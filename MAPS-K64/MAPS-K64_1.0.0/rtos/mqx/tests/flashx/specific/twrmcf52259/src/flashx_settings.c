...
#if LINKER_USED == LINKER_USED_EXTRAM

/* flashx files definition */
const FLASHX_FILE_BLOCK _test_flashx_file_blocks[] = {
   { "cfm",                         0x0000000,   (0x00001000 - 1) }, 
   /* workspace rw */
   { "work_rw",                     0x0001000,   (0x00080000 - 1) }, 
   /* workspace mirror rw */
   { "mirror_rw",                   0x0001000,   (0x00080000 - 1)}, 
   /* ro part of flash tc 6 */
   { "work_ro",                     0x0000000,   (0x00080000 - 1) }, 
   /* part of flash affected by FLASH_IOCTL_ERASE_CHIP */
   { "erased_ro",                   0x0000000,   (0x00080000 - 1) }, 
   /* whole flash to test hw blocks */
   { "whole_ro",                    0x0000000,   (0x00080000 - 1) }, 
   { NULL , 0, 0 } 
};
...
const FLASHX_INIT_STRUCT _test_flashx_init = {
    ...
    _flashx_mcf52xx_block_map, /* HW block map for ColdFire devices */
    _test_flashx_file_blocks, /* Files on the device defined by the BSP */
    &_flashx_mcf52xx_if, /* Interface for low level driver */
