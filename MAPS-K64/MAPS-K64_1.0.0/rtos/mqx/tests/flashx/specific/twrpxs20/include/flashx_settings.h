...
/* cfm settings */
#define CASE3_CFM_ENABLE            (0)
#define CASE3_CFM_OFFSET            (0)
#define CASE3_CFM_SIZE              (0)


/* specific settings of test case no. 4 */
#define CASE4_HALF_PARTIAL          ( \
                                    (CASE4_USE_UNCACHED            << (CASE4_SHIFT_SIZE * 0)) | \
                                    (CASE4_USE_ERASE_SECTOR        << (CASE4_SHIFT_SIZE * 1)) | \
                                    (CASE4_USE_UNCACHED_PASS       << (CASE4_SHIFT_SIZE * 2))   \
                                    )
