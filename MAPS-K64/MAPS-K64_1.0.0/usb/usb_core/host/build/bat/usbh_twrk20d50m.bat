...
copy %USBROOTDIR%\usb_core\host\sources\classes\cdc\usb_host_cdc.h %OUTPUTDIR%\usb_host_cdc.h /Y
copy %USBROOTDIR%\usb_core\host\sources\classes\audio\usb_host_audio.h %OUTPUTDIR%\usb_host_audio.h /Y
copy %USBROOTDIR%\usb_core\host\sources\classes\hub\usb_host_hub_sm.h %OUTPUTDIR%\usb_host_hub_sm.h /Y
copy %USBROOTDIR%\usb_core\host\sources\classes\msd\usb_host_msd_bo.h %OUTPUTDIR%\usb_host_msd_bo.h /Y
copy %USBROOTDIR%\usb_core\host\sources\classes\msd\usb_host_msd_ufi.h %OUTPUTDIR%\usb_host_msd_ufi.h /Y
copy %USBROOTDIR%\usb_core\host\sources\classes\phdc\usb_host_phdc.h %OUTPUTDIR%\usb_host_phdc.h /Y
